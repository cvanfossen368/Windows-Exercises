...
tuple[2] = 1000 # Invalid syntax with tuple. 1000 cannot replace any numbers in the tuple.
list[2] = 1000 #Valid syntax with list. 1000 will replace 2.23 in the list.